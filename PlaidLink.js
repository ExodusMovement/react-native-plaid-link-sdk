...
PlaidLink.propTypes = {
  ...
  // launching Link and using one or more European country codes.
  ...
  // launching or re-launching Link and using one or more European country codes.
  ...
  // re-launching Link and using one or more European country codes.
